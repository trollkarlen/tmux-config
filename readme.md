...
Prerequisites:
- tmux >= "v2.4"
- OSX, Linux (tested on Ubuntu 18 and CentOS7), FreeBSD (tested on 12.0)

Personally, I use it on MacOS 10.14.6 Mojave through Terminal.

On OSX you can install latest 2.9a version with `brew install tmux`. On Linux it's better to install from source, because official repositories usually contain outdated version. For example, CentOS7 - v1.8 from base repo, Ubuntu 18 - v2.6 from trusty/main. For how to install from source, see this [gist](https://gist.github.com/P7h/91e14096374075f5316e) or just google it.


To install tmux-config:
```
$ git clone https://github.com/trollkarlen/tmux-config.git
